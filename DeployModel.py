...
'''tts = gTTS(text = 'welcome to crowd anomaly detection system', lang ='en')
tts.save('say.mp3')'''
playsound('say.mp3')
...
if __name__=='__main__':
    ...
    window.title("Anomaly Detector")

    window.geometry('650x500')

    lbl = Label(window, text="Anomaly Detector",font=("Arial Bold", 40))

    lbl.place(x=330, y=60, anchor="center")

    lbl = Label(window, text="Choose your file ", font=("Arial", 14))

    lbl.place(x=270, y=225, anchor="center")
    ...
    btn = Button(window, text="Open", command=clicked, width=6,height=1)
    arial = tkFont.Font(family='Arial', size=14)
    btn['font'] = arial
    btn.place(x=400, y=225, anchor="center")

...
def Frame_Extractor(v_file, path='./', ext='.avi', frames_dir='train_1', extract_rate='all', frames_ext='.jpg'):
    ...
    frameRate = cap.get(50) #frame rate
...
if __name__=='__main__':    
    ...
    # path = frames_dir
    paths = ['Datasets/AvenueDataset/training_videos'] #'Datasets/UCSDped1/Train', 'Datasets/UCSDped2/Train', 
    ...
    for path in paths:
        ...
        img_arr = GlobalNormalization(img_list, name, path='Train_Data', save_data=True)